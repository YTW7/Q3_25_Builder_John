...
// Recipient address
const to = new PublicKey("F2nXZ8rDHhW6Ud6b6FAyQzqk1Fxmp6XVAowKEFAiaupF"); //q3 destination acc
...
(async () => {
    try {
        ...
        const tx = await transfer(connection, keypair, ataFrom.address, ataTo.address, keypair.publicKey, BigInt(10)*token_decimals)
    } catch(e) {
